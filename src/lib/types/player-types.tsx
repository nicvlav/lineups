import { StatsKey, PlayerStats, CategorizedStats, StatCategory } from "@/lib/types/stat-types"; // Importing from shared file
import { Point, PositionShortLabels, normalizedDefaultWeights, ZoneScores, emptyZoneScores, Weighting, Position } from "@/lib/utils/position-types"; // Importing from shared file
