...
export function playerWithArchetypesToScoredGamePlayer(
    ...
    const bestPosition: Position = (Object.entries(positionScores) as [Position, number][]).reduce(
 ...
 */
export function preCalculatePlayerAnalytics(players: FastPlayer[], config: BalanceConfiguration): void {
