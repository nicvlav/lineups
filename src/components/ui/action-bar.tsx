 ...
 */
export const ActionBarGroup: React.FC<ActionBarGroupProps> = ({ 
  children, 
  className,
  variant = 'default'
}) => {
...
export const ActionBarThreeColumn: React.FC<{
  ...
  return (
    <ActionBar variant={variant} className={cn("grid grid-cols-3", className)}>
      <ActionBarSection alignment="left">
        {left}
      </ActionBarSection>
      <ActionBarSection alignment="center">
        {center}
      </ActionBarSection>
      <ActionBarSection alignment="right">
        {right}
      </ActionBarSection>
    </ActionBar>
  );
