import { AlertCircle, CheckCircle, Eye, EyeOff, Facebook, Loader2, Lock, Mail, UserPlus } from "lucide-react";
...
export default function SignUpPage() {
    ...
    const { user, signUpWithEmail, signInWithFacebook } = useAuth();
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="w-full max-w-md space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-muted-foreground">Join our community to start voting on player ratings</p>
                </div>
