        ...
        <Dialog open={open} onOpenChange={canClose ? onClose : undefined}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Your squad ({user?.profile?.squad_id?.slice(0, 8)}...) is verified. Now select which player you
                        are.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <div className="bg-muted p-3 rounded-lg">
                            <div className="flex items-start gap-2">
                                ...
                                <div className="text-sm text-muted-foreground">
                                    ...
                                    <p className="text-xs">
                                        After selecting your player, you'll be able to participate in voting and use all
                                        features.
                                    </p>
                                </div>
                            </div>
